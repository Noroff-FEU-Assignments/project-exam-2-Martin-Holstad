  ...
  return (
    <div className={styles.container}>
      ...
      <div>
        ...
        <img className={styles.image} src={baseUrl + accommodation.attributes.main_image.data.attributes.url} alt={accommodation.attributes.main_image.data.attributes.alternativeText} />
